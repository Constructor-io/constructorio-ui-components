...
// Card with swatches and interaction callbacks
export const WithSwatchInteraction: Story = {
  args: {
    product: {
    ...
    priceCurrency: '$',
    onSwatchClick: (_, swatch) => console.log('Swatch clicked:', swatch),
    onAddToCart: (_, product) => console.log('Added to cart:', product),
  },
};
