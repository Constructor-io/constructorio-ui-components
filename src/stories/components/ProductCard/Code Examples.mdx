...
The ProductCard component exports its inner components, allowing you to create completely custom layouts by reordering and composing the individual sections using Compound Components, children or render props.
However, passing `componentOverrides` as props to sub-components is not allowed.
