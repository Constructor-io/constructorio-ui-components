...
- `ProductCard.ImageSection` - Product image with overlay support for badges/buttons
  - `ProductCard.Badge` - Product badge/label display
  - `ProductCard.WishlistButton` - Wishlist toggle button
- `ProductCard.Content` - Content wrapper component
  ...
  - `ProductCard.SwatchSection` - Color/variation swatch buttons with optional "View more" support
- `ProductCard.Footer` - Footer wrapper component
